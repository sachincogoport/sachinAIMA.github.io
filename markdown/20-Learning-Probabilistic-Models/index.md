...
<button type="button" class="btn btn-dark float-right" onclick="bookmark('ex20.2');" href="#"><i id="ex20.2" class="fas fa-bookmark" style="color:white"></i></button>
<button type="button" class="btn btn-dark float-right" style="margin-left:10px; margin-right:10px;" onclick="upvote('ex20.2);" href="#"><i id="ex20.2" class="fas fa-thumbs-up" style="color:white"></i></button>
</div>
<div class="card-body">
...
<button type="button" class="btn btn-dark float-right" onclick="bookmark('ex20.4');" href="#"><i id="ex20.4" class="fas fa-bookmark" style="color:white"></i></button>
<button type="button" class="btn btn-dark float-right" style="margin-left:10px; margin-right:10px;" onclick="upvote('ex20.4);" href="#"><i id="ex20.4" class="fas fa-thumbs-up" style="color:white"></i></button>
</div>
<div class="card-body">
...
<button type="button" class="btn btn-dark float-right" onclick="bookmark('ex20.10');" href="#"><i id="ex20.10" class="fas fa-bookmark" style="color:white"></i></button>
<button type="button" class="btn btn-dark float-right" style="margin-left:10px; margin-right:10px;" onclick="upvote('ex20.10);" href="#"><i id="ex20.10" class="fas fa-thumbs-up" style="color:white"></i></button>
</div>
<div class="card-body">
...
<button type="button" class="btn btn-dark float-right" onclick="bookmark('ex20.11');" href="#"><i id="ex20.11" class="fas fa-bookmark" style="color:white"></i></button>
<button type="button" class="btn btn-dark float-right" style="margin-left:10px; margin-right:10px;" onclick="upvote('ex20.11);" href="#"><i id="ex20.11" class="fas fa-thumbs-up" style="color:white"></i></button>
</div>
<div class="card-body">
