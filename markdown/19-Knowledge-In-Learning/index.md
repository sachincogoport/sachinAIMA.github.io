...
<button type="button" class="btn btn-dark float-right" onclick="bookmark('ex19.2');" href="#"><i id="ex19.2" class="fas fa-bookmark" style="color:white"></i></button>
<button type="button" class="btn btn-dark float-right" style="margin-left:10px; margin-right:10px;" onclick="upvote('ex19.2);" href="#"><i id="ex19.2" class="fas fa-thumbs-up" style="color:white"></i></button>
</div>
<div class="card-body">
...
<button type="button" class="btn btn-dark float-right" onclick="bookmark('ex19.3');" href="#"><i id="ex19.3" class="fas fa-bookmark" style="color:white"></i></button>
<button type="button" class="btn btn-dark float-right" style="margin-left:10px; margin-right:10px;" onclick="upvote('ex19.3);" href="#"><i id="ex19.3" class="fas fa-thumbs-up" style="color:white"></i></button>
</div>
<div class="card-body">
...
<button type="button" class="btn btn-dark float-right" onclick="bookmark('ex19.4');" href="#"><i id="ex19.4" class="fas fa-bookmark" style="color:white"></i></button>
<button type="button" class="btn btn-dark float-right" style="margin-left:10px; margin-right:10px;" onclick="upvote('ex19.4);" href="#"><i id="ex19.4" class="fas fa-thumbs-up" style="color:white"></i></button>
</div>
<div class="card-body">
...
<button type="button" class="btn btn-dark float-right" onclick="bookmark('ex19.8');" href="#"><i id="ex19.8" class="fas fa-bookmark" style="color:white"></i></button>
<button type="button" class="btn btn-dark float-right" style="margin-left:10px; margin-right:10px;" onclick="upvote('ex19.8);" href="#"><i id="ex19.8" class="fas fa-thumbs-up" style="color:white"></i></button>
</div>
<div class="card-body">
